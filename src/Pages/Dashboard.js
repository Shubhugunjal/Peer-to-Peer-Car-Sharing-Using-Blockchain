...
class Dashboard extends Component {
  ...
  async loadWeb3() {
    if (window.ethereum) {
      ...
      window.web3 = new Web3.providers.HttpProvider("127.0.0.1:7545")
    }
    else {
  ...
  render() {
    ...
    const authorizedAccounts = ['0x4Ba61828cAA7828d9d449bBc9c0450b40Aa7Dd1c'.toLowerCase()]
    const authorizedAccounts2 = ['0x1774465C00883ffA0D9Ec93A5C2E508E45b17AE7'.toLowerCase()]
